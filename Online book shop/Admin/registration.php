...
<body>
  ...
  <br><span class="error" id="namEerr"> <?php echo $nameerr;?></span><hr>
		...
		<div class="content1">
			<input type="text" id="email" name="email" placeholder="Enter Your Email" class="input"  onkeyup="checkEmail()" onblur="checkEmail()" onclick="checkEmail()">
		...
		<div class="content1">
			<input type="text" class="input" id="user_name" name="user_name" placeholder="Enter User Name" onkeyup="checkuerName()" onblur="checkuerName()" onclick="checkuerName()">
