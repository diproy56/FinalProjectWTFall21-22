...
<div class="contact_table">
    ...
    <table>
        <tr>
            <th style="text-align: left;background: Navy;color: white; font-size: 40px; width: 500px;">Contact Us</th>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 500px; height: 30px; "><b>Email:</b><span style="margin-left:10px; ">Onlinebookshop@gmail.com</span></td>
        </tr>
        <tr>
            <td style="width: 500px; height: 30px; background: #eeeeee;"><b>Facebook:</b>
                <link style="margin-left:10px; " rel="stylesheet" type="text/css" href="Facebook.com">facebook.com/Online-Book-Shop
            </td>
        </tr>
    </table>
