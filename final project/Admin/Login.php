...
<body>
    ...
    <form class="wraper" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
      ...
      <hr class="hr_tag">
		...
		<div>
			<div class="Content">
			<input type="text" id="user_name" name="user_name" placeholder="Enter User Name"  class="input_holder" onkeyup="checkuerName()" onblur="checkuerName()" onclick="checkuerName()" value="<?php if(isset($_COOKIE['user_name'])) {echo $_COOKIE['user_name'];} ?>">
