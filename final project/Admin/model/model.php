...
function updatePicture($user_name, $data){
    $conn = db_conn();
    $selectQuery = "UPDATE `user` set `image` = ? where `user_name` = ?";
    try{
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
            $data, $user_name
...
function updateBookPicture($id, $data){
    $conn = db_conn();
    $selectQuery = "UPDATE `book` set `image` = ? where `ID` = ?";
    try{
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
            $data, $id
